  ...
  return (
    <>
      ...
      <Section className="bg-deep">
        ...
        <div className="grid md:grid-cols-3 gap-5 max-w-6xl mx-auto">
          {[
            { n: "م. عبدالله السهلي", r: "رائد أعمال", q: "تجربة احترافية من أول لقاء حتى استلام السجل التجاري. فريق سلاسة ساعدني أتجنب أخطاء كثيرة." },
            { n: "أ. نورة العتيبي", r: "مديرة شركة تقنية", q: "السرعة والشفافية في تأسيس الشركة كانت مذهلة. أنصح أي مستثمر يبدأ مع سلاسة." },
            { n: "م. خالد القحطاني", r: "مستثمر سعودي", q: "الدعم بعد التأسيس هو الفرق الحقيقي. سلاسة شريك حقيقي وليس مزود خدمة." },
          ].map(t => (
