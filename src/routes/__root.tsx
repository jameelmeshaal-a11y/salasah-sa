...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "ogCQFggw6q9nYni08NlPWe8iFSLrWPaqr28RWmnRsfA" },
      { property: "og:site_name", content: "Salasah Holding" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@SalasahHolding" },
