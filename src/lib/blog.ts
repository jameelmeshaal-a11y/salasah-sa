...
تشهد المملكة العربية السعودية تحولاً اقتصادياً غير مسبوق ضمن رؤية 2030، مع فتح قطاعات جديدة أمام الاستثمار الأجنبي وتسهيل إجراءات تأسيس الشركات بشكل ملحوظ.

## أنواع الكيانات القانونية

تتوفر عدة أنواع من الكيانات القانونية في المملكة، أبرزها: شركة ذات مسؤولية محدودة (LLC)، شركة شخص واحد، شركة مساهمة مقفلة، وفرع شركة أجنبية. اختيار النوع المناسب يعتمد على طبيعة النشاط، حجم الاستثمار، وعدد الشركاء.

## التراخيص المطلوبة

كل نشاط تجاري يتطلب تراخيص محددة من الجهات المختصة: السجل التجاري من وزارة التجارة، ترخيص النشاط من البلدية أو الهيئة المختصة، التسجيل في الزكاة والضريبة، إضافة إلى التأمينات الاجتماعية.
...
تستهدف رؤية المملكة 2030 تنويع مصادر الدخل وتقليل الاعتماد على النفط، عبر تطوير قطاعات استراتيجية متعددة تفتح فرصاً ضخمة للمستثمرين المحليين والأجانب.

## القطاعات الأكثر جاذبية

### 1. التقنية والتحول الرقمي
استثمارات تتجاوز 100 مليار ريال في البنية التحتية الرقمية، الذكاء الاصطناعي، الحوسبة السحابية، والأمن السيبراني.

### 2. الترفيه والسياحة
مشاريع ضخمة كنيوم، البحر الأحمر، والقدية تخلق طلباً غير مسبوق على خدمات الضيافة والترفيه.

### 3. الطاقة المتجددة
هدف توليد 50% من الكهرباء من مصادر متجددة بحلول 2030، مع مشاريع شمسية وريحية واسعة.

### 4. الصناعة والتعدين
تطوير قطاع التعدين كركيزة ثالثة للاقتصاد، مع فرص في المعادن الاستراتيجية.
