...
تشهد المملكة طفرة في إطلاق المنصات الرقمية التي تخدم قطاعات متعددة من التعليم والصحة إلى التجارة والمقاولات، بدعم من [برنامج التحول الرقمي الحكومي](https://www.dga.gov.sa/ar) و[الهيئة السعودية للبيانات والذكاء الاصطناعي (سدايا)](https://sdaia.gov.sa/ar). هذه المنصات تختصر الإجراءات وترفع الكفاءة.

## أنواع المنصات الناجحة

- **Marketplaces**: تربط البائعين بالمشترين كمتاجر التجزئة الإلكترونية، تحت إشراف [هيئة المحتوى الرقمي](https://dcg.gov.sa/) و[وزارة التجارة](https://mc.gov.sa/ar).
- **SaaS B2B**: حلول برمجية للشركات بنموذج الاشتراك، مع حوافز عبر [وزارة الاتصالات وتقنية المعلومات](https://www.mcit.gov.sa/ar).
- **منصات الخدمات**: تجمع مزودي الخدمة بالعملاء وفق [نظام التجارة الإلكترونية](https://mc.gov.sa/ar/Regulations/Pages/details.aspx?nID=22).
- **منصات تعليمية (LMS)**: للتدريب والتطوير المهني، معتمدة من [المؤسسة العامة للتدريب التقني والمهني (TVTC)](https://www.tvtc.gov.sa/ar).

## بيئة داعمة لرواد الأعمال

- [منشآت — الهيئة العامة للمنشآت الصغيرة والمتوسطة](https://www.monshaat.gov.sa/ar): تمويل، احتضان، وتسريع.
- [بنك التنمية الاجتماعية](https://www.sdb.gov.sa/ar): تمويل المشاريع الناشئة.
- [صندوق الاستثمارات العامة (PIF)](https://www.pif.gov.sa/ar): استثمارات استراتيجية في القطاع التقني.
- [الهيئة العامة للاستثمار في وزارة الاستثمار](https://misa.gov.sa/ar/): تراخيص وحوافز.
